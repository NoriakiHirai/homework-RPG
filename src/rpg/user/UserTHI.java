...
public class UserTHI implements User {
	...
	public UserTHI(String userName, UserType userType, String str, String agi, String hp) throws Exception {
		super();
		logger.log(Level.FINE, " UserTHI(Constructor) start ");
		...
		logger.log(Level.FINE, " UserTHI(Constructor) end ");
	}
